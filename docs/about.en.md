...
- Standard library of building blocks (distributions, operations)
- Computational engines ensuring consistency
- Support for "Models as a Service" (MaaS) via containers
...
**Key features:**
- Web front-end with model gallery and search
- Back-end registry with CI/CD pipelines
- Interoperability with HEPData, Zenodo, and other repositories
...
- Showcase models from all domains
...
- [View the consortium →](consortium/index.md)
- [See opportunities →](opportunities.md)
- [Contact us →](consortium/contact.md)
